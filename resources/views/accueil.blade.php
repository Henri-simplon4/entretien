        ...
        <div class="sidebar-body pt-0 data-scrollbar">
            <div class="sidebar-list">
                <ul class="navbar-nav iq-main-menu nav nav-tabs" id="sidebar-menu" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="#accueil.blade.php"
                    ...
                    <li class="nav-item">
                        <a class="nav-link nav-panel " href="#sidebar-users" id="users-pages" data-bs-toggle="tab"
                            data-sidebar-toggle="tooltip" data-bs-placement="right" data-bs-target="#sidebar-users"
                            role="tab" aria-controls="sidebar-users" aria-selected="false" title="Users">
                            <i class="icon">
                                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('parametre')}}"
                            data-sidebar-toggle="tooltip" data-bs-placement="right" title="parametre">
                            <i class="icon">
                                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.4"
                    ...
                    {{-- <li class="nav-item">
                        <a class="nav-link"
                            href="https://templates.iqonic.design/lite/vroom/documentation/html/dist/main/"
                            data-sidebar-toggle="tooltip" data-bs-placement="right" title="Documentation">
                            <i class="icon">
                                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.4"
                ...
                <ul class="navbar-nav" id="sidebar-menu-auth">
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-auth" role="button"
                            aria-expanded="true" aria-controls="sidebar-menu-auth">
                ...
                <ul class="navbar-nav" id="sidebar-menu-users">
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-user" role="button"
                            aria-expanded="true" aria-controls="sidebar-menu-users">
                        ...
                        <ul class="sub-nav collapse show" id="sidebar-user" data-bs-parent="#sidebar-menu-users">
                            <li class="nav-item">
                                <a class="nav-link " href="{{ route('liste') }}">
                                    ...
                                    <span class="item-name">Liste des inscrits</span>
                                </a>
                            </li>
                            <li class="nav-item">
                        ...
                        <ul class="navbar-nav ms-auto align-items-center navbar-list mb-2 mb-lg-0">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link" data-toggle="dropdown" href="#">
                                    <i class="fas fa-user" style="color: black;"></i><span class="pl-2"
                                ...
                                <div class="d-flex">
                                    <div class="d-flex flex-column justify-content-between p-2 iq-icons-bg rounded-pill me-3">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24">
                                            <path
                                                d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10s10-4.48 10-10S17.52 2 12 2zm0 16h-2v-2h2v2zm0-4h-2V5h2v9z"
                                                fill="red" />
                                        </svg>
                                        <svg width="24" height="16" viewBox="0 0 14 16" fill="none"
                                    ...
                                    <div class="d-flex">
                                        <div>
                                            ...
                                            <p class="text-light">Une application qui vous accompagne pour la gestion de vos entretiens.</p>
                ...
                <section class="slideshow">
                    ...
                    <div class="content">
                        ...
                        <div class="content-carrousel">
                            ...
                            <figure class="shadow"><img src="{{asset('images/200.jpg')}}"></figure>
                            <figure class="shadow"><img src="{{asset('images/10105.jpg')}}"></figure>
                            <figure class="shadow"><img src="{{asset('images/10104.jpg')}}"></figure>
                            <figure class="shadow"><img src="{{asset('images/transmi.jpg')}}"></figure>
                            <figure class="shadow"><img src="{{asset('images/flanc.jpg')}}"></figure>
                            <figure class="shadow"><img src="{{asset('images/61.jpg')}}"></figure>
                            <figure class="shadow"><img src="{{asset('images/80.jpg')}}"></figure>
                            <figure class="shadow"><img src="{{asset('images/thumb.webp')}}"></figure>
                            <figure class="shadow"><img src="{{asset('images/phare.jpg')}}"></figure>
